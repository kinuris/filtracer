...
<div class="bg-gray-100 w-full h-full p-8">
    ...
    <div class="flex flex-wrap">
        ...
        <a class="m-2" href="/department/{{ $dept->id }}">
            <div class="bg-white aspect-[5/3] max-w-72 min-w-72 p-4 border shadow rounded-lg flex flex-col items-center justify-between">
                <img src="{{ asset('storage/departments/' . $dept->logo) }}" alt="{{ $dept->name }}">
